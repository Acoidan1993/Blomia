...
var controller = {
    ...
    saveProject: function(req, res) {
        ...
        project.Referencia = params.Referencia;
        project.Tamaño = params.Tamaño;
        project.Stock = params.Stock;
        project.Activo = params.Activo;
        project.Tipo = params.Tipo;
        ...
        if(req.files){
            ...
            if(fileExt == 'png' || fileExt == 'jpeg' || fileExt == 'jpg' || fileExt == 'gif'){
                ...
                fs.unlink(filePath, (err) => {
                    return res.status(200).send({
                        message: 'La extensión de la imagen que quiere subir no es válida.'
                    })
                });
            }
